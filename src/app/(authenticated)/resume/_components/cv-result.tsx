...
import { type Reco } from "@/app/(authenticated)/form-user-data/_components/complete-form"
...
export default function CVResult({ recommendations, loading, error }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      {recommendations.length === 0 ? (
        <p className="text-sm text-muted-foreground">Belum ada rekomendasi. Upload CV & klik Generate.</p>
      ) : (
